...
void func_8029CF0C(struct ActorSpawnData* spawnData, struct FallingRock* rock) {
    ...
    struct ActorSpawnData* temp_v0 = (struct ActorSpawnData*) SEGMENT_TO_PTR(segment, offset);
...
void spawn_falling_rocks(struct ActorSpawnData* spawnData) {
    ...
    struct ActorSpawnData* temp_s0 = (struct ActorSpawnData*) SEGMENT_TO_PTR(addr, offset);
