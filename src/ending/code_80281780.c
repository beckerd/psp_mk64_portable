...
#ifndef TARGET_N64
    port_set_segment_table(0xB, &gPortCeremonyDataSegTable);
    set_segment_base_addr(0xB, NULL);
    port_set_segment_table(6, &gPortCourseSegTables[COURSE_BANSHEE_BOARDWALK].seg6);
